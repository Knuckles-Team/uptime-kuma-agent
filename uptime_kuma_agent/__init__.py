...
OPTIONAL_MODULES = {
    "uptime_kuma_agent.agent_server": "agent",
    "uptime_kuma_agent.mcp_server": "mcp",
}
...
_MCP_AVAILABLE = OPTIONAL_MODULES.get("uptime_kuma_agent.mcp_server") in [
    m.__name__ for m in globals().values() if hasattr(m, "__name__")
]
_AGENT_AVAILABLE = "uptime_kuma_agent.agent_server" in globals()
