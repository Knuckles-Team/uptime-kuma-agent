import os
from uptime_kuma_api import UptimeKumaApi, Timeout, UptimeKumaException
...
def get_client() -> UptimeKumaApi:
    ...
    if _client is None:
        ...
        try:
            ...
            _client = None
            raise RuntimeError(f"Failed to authenticate with Uptime Kuma at {base_url}: {e}") from e
