...
# Paths
ROOT_DIR = '/home/apps/workspace/agent-packages/agents/uptime-kuma-agent'
...
def test_concept_parity():
    """
    Enforces that all concepts documented or used in uptime-kuma-agent
    ...
    assert not unregistered_concepts, (
        f"The following concepts are used in uptime-kuma-agent but are NOT registered "
